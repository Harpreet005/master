...
localStorage.setItem('ctrlsfs',ctrlsf); 
 ...
 data = "<div class='class-title_"+j+"'>"+t+"<div class='student-class-page2-cls'><!--p class='class_page2-cls'><a onclick='geteacher1("+id+");'> "+id+" </a></p--><p class='class_page2-cls-subjct'><a onclick='geteacher1("+id+");'>"+classnames+"</a></p></div>";
...
localStorage.setItem('ctrlsfs',ctrlsf); 
 ...
 data = "<div class='class-title_"+j+"'>"+t+"<div class='student-class-page2-cls'><!--p class='class_page2-cls'><a onclick='geteacher("+id+");'> "+id+" </a></p--><p class='class_page2-cls-subjct'><a onclick='geteacher("+id+");'>"+classnames+"</a></p></div>";
 jQuery('#student-class-pge').append(data);
...
var url="http://bahuka.com/home/images";
//http://bahuka.com/home/images/avatar/thumb_53a1c4a6d21f680e77589992.jpg
datagu = ""+tt+"<div class='best-teacher-match-found' id="+usridp+" ><div class='best-match-page'><div class='best-match-pro'><div class='best-tchr-image'><img onclick=viewprfl("+usridp+") src='"+img+"'></div></div><div class='best-match-text'><div id='chartContainer_"+ra+"' class='containdercss'></div></div></div><div class='best-pst-crt'></div><div class='bottom-colm'><div class='score-left hhh'><div class='score-img score-img2'><img src='img/red-minus-th.png'  onclick='deleteteacher("+teacherlistinid1+","+usridp+");'></div></div><div class='thr-nme-best hhhh'><p>"+usernamep+"</p><p class='professercls'>Prefessor</p></div><div class='best-match-classes-div'><div class='view-detail-thr' id='har'><p id='"+class_id+"' suneel='"+usridp+"' class='harff' onclick='detailteacherpage1(this);'>Details</p></div></div></div><div class='line-end'></div></div>";
...
if(verb=='post'){
   ...
   var artcle="<div class='article-post'>"+title+""+iframe+"</div>"+ddss+"<div class='artcle-like'>"+likescounta+""+unlikepost+"</div>";
}
/*else{
...
ff="<div class='main_post_wrapper'><div class='main-circle-div'><div class='divcircle_wrapper' id='plusadd"+groupid+"'><img src='img/pluss.png' id='plus"+groupid+"' onclick='joingroup("+groupid+");'></div></div></div>";
  ...
  ff="<div class='main_post_wrapper'><div class='main-circle-div'><div class='divcircle_wrapper' id='plusadd"+groupid+"'><img src='img/checkimg1.png' id='remove"+groupid+"' onclick='removegroup("+groupid+");'></div></div></div>";
    ...
    var groupcenterdiv = "<div class='main--post'><div class='joms-focus__cover'><div style='background:url("+img+") no-repeat center center / cover ;' class='joms-focus__cover-image--mobile'></div><div class='joms-focus__header'><div class='joms-focus__title'><h3>"+groupname+"</h3>"+groupDesc+"</div><div class='joms-avatar--focus'>"+ff+"</div></div><div class='member-liked'><div class='left'><a onclick='getgroupmembers("+id+");'>Members</a><span class='blue-like'> "   +members+ "</span></div><div class='right'><p class='blue-like1'>"+likes+"</p><p class='imgspan'><img src='img/fblike.png'></p></div></div></div><div class='joms-postbox-input joms-inputbox'><textarea id='add_post' class='input input-status' name='add_post' placeholder='Ask a question,post resources start a # ,or post your notes....' rows='4' cols='31' onclick='myFunction();'></textarea><div class='pixform-left'><img  src='img/images.png'onclick ='getImage();'><div id='imageLoading'></div></div><div class='status' style='display:none;'>Image uploading successfully</div><div class='post-hidden'><input type='button' name='post' value='post' id='button-post'  onclick='addpost("+groupid+");' style='display:none;' ></div></div></div><div id='postdata-main'>"+postdata+"</div>   "; 
                                     
            jQuery(".notification_main").append(groupcenterdiv);
...
//alert(photomain2);
                    ...
                    var ddssa="<div class='post-image'><img src='"+photomain2s+"'></div>";
              }
              else{
                ddssa="";
              }
...
if(verb=='post'||app=='photos'){


   var artcle="<div class='article-post'>"+title+""+iframe+"</div>"+ddss+""+ddssa+"<div class='artcle-like'>"+likescounta+""+unlikepost+"</div>";
}
/*else{
  artcle="<div class='article-post  content'><span>"+content+"</span>"+likescounta+"<a class='button' href='javascript:' onclick='likepost("+content_id+")'><span id='like'></span></a></div>";
}*/
if(app=='groups.wall'||app=='photos'){
...
var span="<span  onclick='grouplikess("+groupid+",this);' class='grouplike'>Liked</span>";
 ...
 span="<span  onclick='grouplikess("+groupid+",this);' class='grouplike'>Like</span>";
    ...
    var groupcenterdiv = "<div class='main--post'><div class='joms-focus__cover'><div style='background:url("+img+") no-repeat center center / cover ;' class='joms-focus__cover-image--mobile'></div><div class='joms-focus__header'><div class='joms-focus__title'><h3>"+groupname+"</h3>"+groupDesc+"</div><div class='joms-avatar--focus'>"+ff+"</div></div><div class='member-liked'><div class='left'><a onclick='getgroupmembers("+id+");'>Members</a><span class='blue-like'>"+members+"</span></div><div class='right'><p class='blue-like1'>"+likes+"</p><p class='imgspan'>"+span+"<img src='img/fblike.png'></p></div></div></div><div class='joms-postbox-input joms-inputbox'><textarea id='add_post' class='input input-status' name='add_post' placeholder='Ask a question,post resources start a # ,or post your notes....' rows='4' cols='31' onclick='myFunction();'></textarea><div class='pixform-left'><img  src='img/images.png'onclick ='getImage();'><div id='imageLoading'></div></div><div class='status' style='display:none;'>Image uploading successfully</div><div class='post-hidden'><input type='button' name='post' value='post' id='button-post'  onclick='addpost("+groupid+");' style='display:none;' ></div></div></div><div id='postdata-main'>"+postdata+"</div>   "; 
...
ff="<img src='img/pluss.png'>";
  ...
  ff="";
    ...
    var groupcenterdiv = "<div class='main--post'><div class='joms-focus__cover'><div style='background:url("+img+") no-repeat center center / cover ;' class='joms-focus__cover-image--mobile'></div><div class='joms-focus__header'><div class='joms-focus__title'><h3>"+groupname+"</h3>"+groupDesc+"</div><div class='joms-avatar--focus'>"+ff+"</div></div><div class='member-liked'><div class='left'><a onclick='getgroupmembers("+id+");'>Members</a><span class='blue-like'>"+members+"</span></div><div class='right'><p class='blue-like1'>"+likes+"</p><p class='imgspan'><img src='img/fblike.png'></p></div></div></div><div class='joms-postbox-input joms-inputbox'><textarea id='add_post' class='input input-status' name='add_post' placeholder='Ask a question,post resources start a # ,or post your notes....' rows='4' cols='31' onclick='myFunction();'></textarea><div class='pixform-left'><img  src='img/images.png'onclick ='getImage();'><!--input class='ic-btn ic-btn-md ic-btn-round ic-btn-blue customButtons getphoto' type='button' value='BROWSE' onclick='getImage();'--><div id='imageLoading'></div></div><div class='post-hidden'><input type='button' name='post' value='post' id='button-post'  onclick='addpost1("+groupid+");' style='display:none;' ></div></div></div><div id='postdata-main' class='userprofile-main'>"+postdata+"</div>   "; 
                                     
            jQuery("#student-class-pge").append(groupcenterdiv);
  jQuery(".search-post").append('<input type="text" placeholder="Search... " name="search" id="postsrch" onclick="postsrch('+id+');" >');
...
jQuery('#plusadd'+groupid).html("<img src='img/pluss.png' id='plus"+groupid+"' onclick='removegroup("+groupid+");'>");
...
function notifications(){
 ...
 var notificationdiv="";
      ...
      { 
        if(actor!=null){
          notificationdiv += "<div  class='notification_center' onclick='getgroupwall("+userid+");'><ul class='notific_lists'><li><div class=list_notific_details><div  class='notification_text'><h1><span id='notic_nmber'> "+actor+ "</span> posted in the <span id='notic_action'>"+groupss+"</span></h1><p> "+time+" </p> </div></div></li></ul></div>";
        }
      }
      ...
      else if(cmd_type == 'notif_groups_member_join')
      {
             ...
             if(actor!=null){
          notificationdiv += "<div  class='notification_center'><ul class='notific_lists'><li><div class=list_notific_details><div  class='notification_text'><h1><span id='notic_nmber'> "+user+ "</span> join your<span id='notic_action'>"+groupss+"</span></h1><p> "+time+" </p> </div></div></li></ul></div>";
        }
      }
      else if(cmd_type == 'notif_friends_request_connection')
      {
             if(actor!=null){
          notificationdiv += "<div  class='notification_center'><ul class='notific_lists'><li><div class=list_notific_details><div  class='notification_text'><h1><span id='notic_nmber'> "+actor+ "</span>  requsted to be your friend</h1><p> "+time+" </p> </div></div></li></ul></div>";
        }
      ...
      {
             if(actor!=null){
          notificationdiv += "<div  class='notification_center'><ul class='notific_lists'><li><div class=list_notific_details><div  class='notification_text'><h1><span id='notic_nmber'> "+actor+ "</span>  liked your profile</h1><p> "+time+" </p> </div></div></li></ul></div>";
        }
      }
      ...
      {
             if(actor!=null){
          notificationdiv += "<div  class='notification_center' onclick='getgroupwall("+userid+");'><ul class='notific_lists'><li><div class=list_notific_details><div  class='notification_text'><h1><span id='notic_nmber'> "+actor+ "</span>  created a new <span id='notic_action'>"+groupss+"</span> class photos album in the <span id='notic_action'> "+groupss+"</span> class. </h1><p> "+time+" </p> </div></div></li></ul></div>";
        }
      }
...
if(verb=='post'){
   ...
   var artcle="<div class='article-post'><span>"+title+"</span></div><div class='artcle-like'>"+likescounta+""+unlikepost+"</div>";
}
 ...
 //alert(checkedsess);
  ...
  jQuery.ajax({
    ...
    /*  var myFruitsArray = checkedval.split(',');    
      ...
      datadls = "<div class='class_div'><div class='detailspge'></div><div class='tecr-date-time-ap'><div class='datetme-app'><p id='dte'><b id='clssme'>Dates: "+starm+" "+stard+" - "+enddatem+" "+enddated+"</b></p><p><b id='clssme'>Days:</b>"+class_days+"</p><p><b id='clssme'>Time:</b> "+starttime+" - "+endtime+"</p><p><b id='clssme'>Room:</b> "+class_room+"</p><p><b id='clssme'>CRN:</b><b id='clssme'> "+classcode+"</b></p><p><b id='clssme'>Seats:</b> <b id='steopn'>"+seats+"</b> <b id='clssme'> Taken:</b><b id='steopn'>"+taken+"</b><b id='clssme'> Open:</b><b id='steopn'>"+open+"</b></p></div></div></div>";
...
var unlikepost="<a class='button_"+content_id+"'   href='javascript:' onclick='likepost("+content_id+",this)'>unlike</a>";
}
else{

 unlikepost="<a class='button_"+content_id+"' href='javascript:' onclick='likepost("+content_id+",this)'>like</a>";
}
...
if(verb=='post'||app=='photos'){
   ...
   var artcle="<div class='article-post'><span>"+title+"</span></div><div class='artcle-like'>"+likescounta+"</div>";
}
